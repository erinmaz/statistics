...
\hypersetup{
  ...
  pdfauthor={Lead Author: Matthew J. C. Crump; Chapters 2 and 4 adapted from Navarro, D.; Videos: Jeffrey Suzuki; Version 0.9 (August 7th, 2018) of Crump et al.'s textbook was adapted by Erin L. Mazerolle for PSYC 292, St.~Francis Xavier University},
  hidelinks,
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/1Simpson.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/2happyPlot-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/2happyHist-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/2manyhistbin-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/2meanmodemed-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/unnamed-chunk-3-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/probability/pantsDistribution-eps-converted-to.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/probability/binomSkulls20-eps-converted-to.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/probability/Binomial2.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/probability/standardNormal-eps-converted-to.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/probability/Normal_formula.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/normalMovingMean-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/normalMovingSD-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/estimation/srs1.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/estimation/brs.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/estimation/srs2.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/navIQ.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4Unif-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/sampleHistUnif-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4unifmany-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4samplestats-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/sampleDistNormal-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4sampledistmeannorm-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4samplemeanunif-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4samplemeanExp-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4normalSDspercents-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/4normalSDspercentsB-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/estimation/sampdistsd.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/estimation/biasMean-eps-converted-to.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{navarro_img/estimation/biasSD-eps-converted-to.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5unifagain-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5histunif-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5manysamples-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/sampleUnifExpected-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5whichone-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5unifsamp100-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5unifsamp1000-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5sampunifALOT-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5whichoneB-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5whichoneC-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5gumballA-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5gumballsims-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5gumballdiffs-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5manydiffs-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5histdiffgumball-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5crumptestdiff-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5crumpdecision-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5crumpuncertainty-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5crumpshade-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5sampleDistNormal-1.pdf}}
...
\begin{tabular}{r|r|r}
\hline
sample\_size & smallest & biggest\\
\hline
20 & -22.855367 & 21.722660\\
\hline
40 & -17.915986 & 17.084301\\
\hline
80 & -13.019617 & 11.329878\\
\hline
160 & -8.302319 & 7.889199\\
\hline
\end{tabular}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5crumpminmax-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5crumpredline-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/randomizationTest-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5randhist-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/5randquestion-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6sampleMSEM-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6thisexample-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6sampdists-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6tdecision-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6tnull-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6percentregions-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6critT-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6tonedirection-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6twotailedt-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6dft-1.pdf}}
...
\NormalTok{  my\_sample }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\AttributeTok{n=}\DecValTok{30}\NormalTok{, }\AttributeTok{mean =}\DecValTok{50}\NormalTok{, }\AttributeTok{sd =}\DecValTok{25}\NormalTok{)}
\NormalTok{  t\_test }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{ (my\_sample, }\AttributeTok{mu =} \DecValTok{50}\NormalTok{)}
...
\FunctionTok{hist}\NormalTok{(save\_ts)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6flatp-1.pdf}}
\caption{\label{fig:6flatp-1}The distribution of p-values is flat under the null}
\end{figure}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{(save\_ps)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6flatp-2.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simulated\_ts }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{(}\DecValTok{1000}\NormalTok{,}
                          \FunctionTok{t.test}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{50}\NormalTok{,}\DecValTok{25}\NormalTok{))}\SpecialCharTok{$}\NormalTok{statistic)}
\FunctionTok{hist}\NormalTok{(simulated\_ts)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simtsRep-1.pdf}}
\caption{\label{fig:6simtsRep}Simulating ts in R}
\end{figure}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{simulated\_ps }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{(}\DecValTok{1000}\NormalTok{,}
                          \FunctionTok{t.test}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{50}\NormalTok{,}\DecValTok{25}\NormalTok{))}\SpecialCharTok{$}\NormalTok{p.value)}
\FunctionTok{hist}\NormalTok{(simulated\_ps)}
\end{Highlighting}
\end{Shaded}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simpsRep-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simps1000-1.pdf}}
\caption{\label{fig:6simps1000}1000 simulated ts from the null distribution}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simts1000-1.pdf}}
...
We happened to make 57. The expectation over the long run is 5\% type I error rates (if your alpha is .05).
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simtruets-1.pdf}}
\caption{\label{fig:6simtruets}1000 ts when there is a true difference}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simtrueps-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simtsB-1.pdf}}
\caption{\label{fig:6simtsB}1000 ts for n =100, when there is a true effect}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simpsB-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simtsC-1.pdf}}
\caption{\label{fig:6simtsC}1000 ts for n =100, when there is a true effect}
\end{figure}

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/6simpsC-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3scatter1-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3posnegrand-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3simsum-1.pdf}}
...
Does Pearson's \(r\) really stay between -1 and 1 no matter what? It's true. Take a look at the following simulation. Here I randomly ordered the numbers 1 to 10 for an X measure, and did the same for a Y measure. Then, I computed Pearson's \(r\), and repeated this process 1000 times. As you can see all of the dots are between -1 and 1.

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3onethousandr-1.pdf}}
...
Let's look at some data from the \href{http://worldhappiness.report}{world happiness report} (2018).
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3hsrdata-1.pdf}}
...
We put a blue line on the scatterplot to summarize the positive relationship. It appears that as freedom to make life choices goes up, so too does confidence in national government. It's a positive correlation.
...
We're going to spend the next little bit adding one more thing to our understanding of correlation. It's called \textbf{linear regression}.

First, let's look at a linear regression. Here are some scatter plots that you've already seen, but, we've added something new! Lines.

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3regression-1.pdf}}
...
Notice anything about these blue lines? Hopefully you can see, at least for the first two panels, that they go straight through the data, just like a kebab skewer. We call these lines \textbf{best fit} lines, because according to our definition (explained below), there are no other lines that you could draw that would do a better job of going straight through the data.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3regressionResiduals-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/regression-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3minimizeSS-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3twolines-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3corwithLine-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3snakeplant-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3anotherthousand-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3reminder-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/corUnifn10-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3histrandcor-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/3corrandN-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/corUnifFourNs-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/corNormFourNs-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{gifs/corRealgif-1.gif}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/12effectdists-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/12effectdistsB-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/12powercurve-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/12powercurveN-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/12effectsizeType1-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/7fnull-1.pdf}}
...
\tightlist
\item
  Set an alpha criterion of \(p\) = .05
\item
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/7criticalF-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/7manyDiffs-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/7manyDiffsBar-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/7flesshthanone-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/7sigdiffs-1.pdf}}
\caption{\label{fig:7sigdiffs}Different patterns of group means under the null when F is above critical value. We would make type I errors if our data looked like any of these simulations.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/SS_ANOVA.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/SS_RMANOVA.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/RMANOVA_table.png}}
...
Let's do a couple simulations to see some the differences between the ANOVA for a repeated measures design, and the ANOVA for a between-participants design.
...
\item
  We will include a participant factor for the repeated-measures version. Here there are 10 participants, each contributing three scores, one each condition
\item
  For the between-participants design there are 30 different participants, each contributing one score in the condition they were assigned to (really the group).
\end{enumerate}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/8critcompare-1.pdf}}
\caption{\label{fig:8critcompare}Comparing critical F values for a between and repeated measures design}
\end{figure}

These two \(F\) sampling distributions look pretty similar. However, they are subtly different. The between \(F\) distribution has degrees of freedom 2, and 27, for the numerator and denominator. There are 3 conditions, so df1 = 3-1 = 2. There are 30 participants, so df2 = 30-3 =27. The critical value, assuming an alpha of 0.05 is 3.35. This means \(F\) is 3.35 or larger 5\% of the time under the null.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/8fpvaluedist-1.pdf}}
\caption{\label{fig:8fpvaluedist}p-value distributions for a between and within-participants ANOVA}
\end{figure}
...
For the between participant design, there were 610 experiments with a \(p\) less than 0.05, or 0.61 of experiments were ``significant'', with alpha=.05.

For the within participant design, there were 576 experiments with a \(p\) less than 0.05, or 0.576 of experiments were ``significant'', with alpha=.05.

OK, well, you still might not be impressed. In this case, the between-participants design detected the true effect slightly more often than the repeated measures design. Both them were right around 55\% of the time. Based on this, we could say the two designs are pretty comparable in their sensitivity, or ability to detect a true difference when there is one.

However, remember that the between-participants design uses 30 participants, and the repeated measures design only uses 10. We had to make a big investment to get our 30 participants. And, we're kind of unfairly comparing the between design (which is more sensitive because it has more participants) with the repeated measures design that has fewer participants.

What do you think would happen if we ran 30 participants in the repeated measures design? Let's find out. Here we redo the above, but this time only for the repeated measures design. We increase \(N\) from 10 to 30.

\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/8pdistwithin-1.pdf}}
\caption{\label{fig:8pdistwithin}p-value distribution for within-participants design with n= 30}
\end{figure}

Wowsers! Look at that. When we ran 30 participants in the repeated measures design almost all of the \(p\)-values were less than .05. There were 972 experiments with a \(p\) less than 0.05, or 0.972 of experiments were ``significant'', with alpha=.05. That's huge! If we ran the repeated measures design, we would almost always detect the true difference when it is there. This is why the repeated measures design can be more sensitive than the between-participants design.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/8behmcrump-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/2x2Design.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/2x3Design.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/spot_dif.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/9meandiff-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/9reward-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/9rewardB-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/9visualdiffs-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/9alleffects-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/Stroop.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/9strp-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/10bar22-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/10lines22-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/10mainint-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/10mainintInc-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/1023design-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/1023one-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/1023int-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/10222-1.pdf}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/10222int-1.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{num\_sims        }\OtherTok{\textless{}{-}}\DecValTok{500}
\NormalTok{N               }\OtherTok{\textless{}{-}}\FunctionTok{c}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{20}\NormalTok{,}\DecValTok{30}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DecValTok{50}\NormalTok{)}
\NormalTok{mean\_difference }\OtherTok{\textless{}{-}}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{12}\NormalTok{,}\DecValTok{16}\NormalTok{,}\DecValTok{20}\NormalTok{)}
\NormalTok{save\_ps}\OtherTok{\textless{}{-}}\FunctionTok{length}\NormalTok{(num\_sims)}

\NormalTok{all\_df}\OtherTok{\textless{}{-}}\FunctionTok{data.frame}\NormalTok{()}
\ControlFlowTok{for}\NormalTok{(diff }\ControlFlowTok{in}\NormalTok{ mean\_difference)\{}
...
\NormalTok{      group\_A }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(j,}\DecValTok{100}\NormalTok{,}\DecValTok{7}\NormalTok{)}
\NormalTok{      group\_B }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(j,}\DecValTok{100}\SpecialCharTok{+}\NormalTok{diff, }\DecValTok{7}\NormalTok{)}
\NormalTok{      t\_results }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(group\_A,group\_B,}\AttributeTok{var.equal =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{      save\_ps[i] }\OtherTok{\textless{}{-}}\NormalTok{ t\_results}\SpecialCharTok{$}\NormalTok{p.value}
\NormalTok{    \}}
\NormalTok{    sim\_df }\OtherTok{\textless{}{-}}\FunctionTok{data.frame}\NormalTok{(save\_ps,}
                        \AttributeTok{num\_subjects=}\FunctionTok{as.factor}\NormalTok{(}\FunctionTok{rep}\NormalTok{(j,num\_sims)),}
                        \AttributeTok{mean\_diff =}\FunctionTok{rep}\NormalTok{(diff,num\_sims))}
\NormalTok{    all\_df }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(all\_df,sim\_df)}
\NormalTok{  \}}
\NormalTok{\}  }

\NormalTok{plot\_df }\OtherTok{\textless{}{-}}\NormalTok{ all\_df }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{            dplyr}\SpecialCharTok{::}\FunctionTok{group\_by}\NormalTok{(num\_subjects,mean\_diff) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{            dplyr}\SpecialCharTok{::}\FunctionTok{summarise}\NormalTok{(}\AttributeTok{proportion\_sig =} \FunctionTok{length}\NormalTok{(save\_ps[save\_ps}\SpecialCharTok{\textless{}}\FloatTok{0.05}\NormalTok{])}\SpecialCharTok{/}\NormalTok{num\_sims)}


\FunctionTok{ggplot}\NormalTok{(plot\_df, }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{mean\_diff, }
                    \AttributeTok{y=}\NormalTok{proportion\_sig, }
                    \AttributeTok{group=}\NormalTok{num\_subjects, }
                    \AttributeTok{color=}\NormalTok{num\_subjects))}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{()}\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{statistics_files/figure-latex/unnamed-chunk-98-1.pdf}}
...
\hline
  & Df & Sum Sq & Mean Sq & F value & Pr(>F)\\
\hline
groups & 2 & 315.3057 & 157.6528 & 0.6962442 & 0.4992656\\
\hline
Residuals & 297 & 67250.6813 & 226.4333 & NA & NA\\
\hline
\end{tabular}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/corNormFourNsTypeI-1.gif}}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/cellsizeCor-1.gif}}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/sampleNullTrue-1.gif}}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/indTtest.gif}}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/indTtestTrue.gif}}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/indTtestN.gif}}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/OneWayNull.gif}}
...
\pandocbounded{\includegraphics[keepaspectratio]{gifs/FactorialNull.gif}}
...
\includegraphics[width=300px]{gifs/normalMovingMean-1}
